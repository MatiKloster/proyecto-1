...
var levels = [new Level(posiblesPalabrasLevel1, 10, 10, 5, { backwards: 0 }), new Level(posiblesPalabrasLevel2, 15, 15, 7, { backwards: 0.3 }), new Level(posiblesPalabrasLevel3, 15, 15, 10, { backwards: 0.6, letters: 'aaaaaaaaaaaaaaaaaaaaaaaaabcdfghjklmnpqrstvwxyz' })];
...
var makeLevelGreatAgain = function (neededLevel) {
    switch (neededLevel) {
        case 0:
            levels[0] = new Level(posiblesPalabrasLevel1, 10, 10, 5, { backwards: 0 });
            draftedWordsPerLevel[0]=levels[0].draftedWords;
            break;
        case 1:
            levels[1] = new Level(posiblesPalabrasLevel2, 15, 15, 7, { backwards: 0.3 });
            draftedWordsPerLevel[1]=levels[1].draftedWords;
            break;
        case 2:
            levels[2] = new Level(posiblesPalabrasLevel3, 15, 15, 10, { backwards: 0.6, letters: 'aaaaaaaaaaaaaaaaaaaaaaaaabcdfghjklmnpqrstvwxyz' });
