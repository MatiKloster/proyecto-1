    ...
    var levels=[new Level(posiblesPalabrasLevel1, 10, 10, 5, { backwards: 0 }),new Level(posiblesPalabrasLevel2, 12, 12, 7, { backwards: 0.3 }),new Level(posiblesPalabrasLevel3, 15, 15, 10, { letters: 'aaaaaaaaaaaaaaaaaaaaaaaaabcdfghjklmnpqrstvwxyz'})];
